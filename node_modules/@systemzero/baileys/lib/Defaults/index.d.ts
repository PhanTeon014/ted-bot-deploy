...
import { DisconnectReason, type SocketConfig } from '../Types/index.js';
export declare const UNAUTHORIZED_CODES: number[];
/**
 * Motivos de `connection.update` (close) que significam sessão realmente inválida —
 * fora desses (inclusive `connectionReplaced`/440), a conexão caiu mas as
 * credenciais continuam válidas.
 */
export declare const FATAL_DISCONNECT_REASONS: DisconnectReason[];
...
export declare const DEFAULT_MAX_MEDIA_UPLOAD_BYTES: number;
